...
export const defaultExample = () => React.createElement("div", {
  className: "row-gap"
}, React.createElement(Button, null, " \u0421\u0442\u0430\u043D\u0434\u0430\u0440\u0442\u043D\u0430\u044F \u043A\u043D\u043E\u043F\u043A\u0430 "));
export const sizeExample = () => React.createElement("div", {
  className: "row-gap"
}, React.createElement(Button, {
  size: "s"
}, "size s primary"), React.createElement(Button, {
  size: "m"
}, "size m primary"), React.createElement(Button, {
  size: "l"
}, "size l primary"), React.createElement(Button, {
  size: "xl"
}, "size xl primary"), React.createElement(Button, {
  size: "xxl"
}, "size xxl primary"));
export const colorThemeExample = () => React.createElement("div", {
  className: "row-gap"
}, React.createElement(Button, {
  colorTheme: "primary"
}, "primary"), React.createElement(Button, {
  colorTheme: "ghost-orange"
}, "ghost-orange"), React.createElement(Button, {
  colorTheme: "ghost-gray"
}, "ghost-gray"));
export const isFoolWithExample = () => React.createElement("div", {
  className: "row-gap"
}, React.createElement(Button, {
  isFoolWith: true
}, "full width"), React.createElement("div", {
  style: {
    width: '50%'
  }
}, React.createElement(Button, {
...
const iconGear = React.createElement("svg", {
  ...
  width: "16",
  height: "16"
}, React.createElement("title", null, "AUTOMATION"), React.createElement("path", {
