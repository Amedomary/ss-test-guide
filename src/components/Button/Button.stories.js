...
stories
  ...
  // Цвета
  .add('colorThemeExample', () => (
    <div className="row-gap">
      <Button colorTheme="primary">primary</Button>
      <Button colorTheme="ghost-orange">ghost-orange</Button>
      <Button colorTheme="ghost-gray">ghost-gray</Button>
    </div>
  ))

  // На всю ширину
  .add('isFoolWithExample', () => (
    <div className="row-gap">
      <Button isFoolWith>full width</Button>
      <div style={ { width: '50%' } }>
        <Button isFoolWith>full width</Button>
      </div>
    </div>
  ...
  .add('iconExapmle', () => (
    <div className="row-gap">
      <Button icon={ iconGear }> + icon </Button>
      <Button icon={ iconGear } />
      <Button icon={ iconGear } size="xl" />
      <Button icon={ iconGear } colorTheme="ghost-orange" />
      <Button icon={ iconGear } colorTheme="ghost-gray" />
      <Button icon={ iconGear } isDisabled />
    </div>
  ))
  ...
  .add('disabledExample', () => (
    <div className="row-gap">
      ...
      <Button isDisabled size="xl"> isDisabled </Button>
      <Button isDisabled colorTheme="ghost-orange"> isDisabled </Button>
      <Button isDisabled colorTheme="ghost-gray"> isDisabled </Button>
      <Button icon={ iconGear } isDisabled> isDisabled </Button>
    </div>
  ));
  // .add('Default2', () => (<></>))
...
.add('Interactive with knobs', () => {
  const value = select('Size', ['s', 'm', 'l', 'xl', 'xxl'], 'l');
  const theme = select('Theme', ["primary", "ghost-orange", "ghost-gray"], "primary")
  const checkD = boolean('Disabled', false);
  const checkF = boolean('Full width', false);
  ...
  return (
    <div className="row-gap">
      <Button
        ...
        colorTheme={ theme }
      >
        { text('Text', 'Интерактивная кнопка') }
      </Button>
    </div>
  )
});